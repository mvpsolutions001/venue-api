...
// console.log("header length", headerBase64.length);
// console.log("footer length", footerBase64.length);

// console.log(fs.existsSync("services/vrc_pdf_template/header.png"));

// console.log(fs.existsSync("services/vrc_pdf_template/image_794150301_0.jpg"));
        ...
        <table class="waffle" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <tr style="height: 19px">
                    ...
                    <td class="s2"></td>
                    <td class="s7" colspan="2" rowspan="4"></td>
